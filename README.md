...
- **CLI Tools (Homebrew)**: bat, eza, fd, ripgrep (rg), git-delta, vivid, nushell, fish, starship, zoxide, helix, numbat, yazi, ruff, topiary - Modern CLI utilities, shells, and text editor for enhanced productivity
